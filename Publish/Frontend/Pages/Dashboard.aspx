            ...
            <div class="modal-dialog modal-dialog-centered" style="width: 408px; height: 264px;" role="document">
                <div class="modal-content px-3 py-2">
                    ...
                    <div class="modal-body">
                        ...
                        <table>
                            <tr>
                                <td width="100px" style="font: normal normal normal 12px/15px Helvetica;">Drug Name</td>
                                <td width="20px">:</td>
                                <td id="drugName"></td>
                                <td></td>
                            </tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if (window.matchMedia("(max-width: 570px)").matches) {
                ...
                $(".searchResponsive").prop("style", "width:165px!important; font-size:12px");
            }
